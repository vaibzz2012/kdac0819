...
namespace Car_Rental_System.Models
{
    ...
    public partial class FinalProject_DBEntities : DbContext
    {
        ...
        public DbSet<T_Billing> T_Billing { get; set; }
        ...
        public virtual int proc_AddRole(string param2)
        {
            var param2Parameter = param2 != null ?
                new ObjectParameter("param2", param2) :
                new ObjectParameter("param2", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("proc_AddRole", param2Parameter);
        }
